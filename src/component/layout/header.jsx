...
const phoneNumber = "+91 9958317089";
const address = "Faridabad, Haryana";
            ...
            <div className="header-bottom">
                <div className="container">
                    <div className="header-wrapper">
                        <div className="logo">
                            <Link to="/"><img src="assets/images/logo/UnnatiBlack.png" alt="logo" /></Link>
                        </div>
                        <div className="menu-area">
                            <div className="menu">
                                <ul className={`lab-ul ${menuToggle ? "active" : ""}`}>
                                    <li className="menu-item-has-children">
                                        <NavLink to="/"> <a href="#" role="button" data-bs-offset="0,0">Home</a></NavLink>
                                    </li>
                                    <li className="menu-item-has-children">
                                    ...
                                    <li className="menu-item-has-children">
                                    <a href="/blog" role="button" data-bs-offset="0,0">Blog</a>
                                    </li>
                                    <li className="menu-item-has-children">
